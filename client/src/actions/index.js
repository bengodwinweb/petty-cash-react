...
export const updateBox = (values, type) => async dispatch => {
  console.log(`PUT to /api/cashboxes/${values._cashbox}/box/${type}`, values);
  // const res = await axios.put(
  //   `PUT to /api/cashboxes/${values._cashbox}/box/${type}`,
  //   values
  // );
